...
export interface IItemPackNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IItemPackNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IItemPackNFT;
  ...
  getEnabled: TypedContractMethod<[], [boolean], "view">;

  getTokens: TypedContractMethod<[owner: AddressLike], [bigint[]], "view">;
